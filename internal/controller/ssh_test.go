...
func TestBuildSSHCommand_RejectsRootPaths(t *testing.T) {
	tests := []struct {
		...
		{
			name:       "rejects linux source path that normalizes to root",
			osType:     "linux",
			mountPath:  "/backup",
			sourcePath: "/tmp/..",
			wantErr:    `sourcePath cannot be a root or disk path: "/tmp/.."`,
		},
		{
			name:       "rejects linux source dot root",
			osType:     "linux",
			mountPath:  "/backup",
			sourcePath: "/./",
			wantErr:    `sourcePath cannot be a root or disk path: "/./"`,
		...
		{
			name:       "rejects linux mount path that normalizes to root",
			osType:     "linux",
			mountPath:  "/var/..",
			sourcePath: "/home/user/data",
			wantErr:    `mountPath cannot be a root or disk path: "/var/.."`,
		},
		{
		...
		{
			name:       "rejects windows source path that normalizes to drive root",
			osType:     "windows",
			mountPath:  `C:\backup`,
			sourcePath: `C:\backup\..`,
			wantErr:    `sourcePath cannot be a root or disk path: "C:\\backup\\.."`,
		},
		{
			name:       "rejects windows source dot drive root",
			osType:     "windows",
			mountPath:  `C:\backup`,
			sourcePath: `C:\.`,
			wantErr:    `sourcePath cannot be a root or disk path: "C:\\."`,
		...
		{
			name:       "rejects windows source current drive root slash",
			osType:     "windows",
			mountPath:  `C:\backup`,
			sourcePath: `/`,
			wantErr:    `sourcePath cannot be a root or disk path: "/"`,
		...
		{
			name:       "rejects windows mount drive root slash",
			osType:     "windows",
			mountPath:  `D:/`,
			sourcePath: `D:\Users\data`,
			wantErr:    `mountPath cannot be a root or disk path: "D:/"`,
		...
		{
			name:       "rejects windows mount path that normalizes to drive root",
			osType:     "windows",
			mountPath:  `D:\backup\..`,
			sourcePath: `D:\Users\data`,
			wantErr:    `mountPath cannot be a root or disk path: "D:\\backup\\.."`,
		},
		{
			name:       "rejects windows mount dot drive root",
			osType:     "windows",
			mountPath:  `D:\.`,
			sourcePath: `D:\Users\data`,
			wantErr:    `mountPath cannot be a root or disk path: "D:\\."`,
		...
		{
			name:       "rejects windows mount current drive root slash",
			osType:     "windows",
			mountPath:  `/`,
			sourcePath: `D:\Users\data`,
			wantErr:    `mountPath cannot be a root or disk path: "/"`,
